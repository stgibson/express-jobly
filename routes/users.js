...
router.get("/:username", ensureLoggedIn, ensureCanAccessUser,
...
router.patch("/:username", ensureLoggedIn, ensureCanAccessUser,
  async function (req, res, next) {
  try {
...
router.delete("/:username", ensureLoggedIn, ensureCanAccessUser,
  async function (req, res, next) {
  try {
